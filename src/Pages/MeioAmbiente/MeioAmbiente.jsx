  ...
  return (
    <div className='meio-ambiente'>
      ...
      <div className='box-video'>
        ...
        <p>A Seafety apresenta a solução que leva mais sustentabilidade para os oceanos com <span> informações e insights</span> sobre ele.</p>
      </div>
      <div className='box-icons'>
        <img className='icon-ma' src={icon1} />
        <img className='icon-ma' src={icon2} />
        <img className='icon-ma' src={icon3} />
      </div>
      <div className='box-icons-text'>
      ...
      <div className='box-icons'>
        <img className='icon-ma' src={icon4} />
        <img className='icon-ma' src={icon5} />
        <img className='icon-ma' src={icon6} />
      </div>
      <div className='box-video'>
        <video className='video-ma' preload="auto" autoplay="" loop muted playsInline>
        ...
        <p> Nossas análises ajudam a minimizar o impacto ambiental das atividades marítimas.</p>
