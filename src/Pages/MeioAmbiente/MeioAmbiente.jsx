      ...
      <div className="meio-ambiente">
        <div className="box-video">
          ...
          <div className="text-overlay">
            <p>
              Os oceanos concentram{" "}
              <span>cerca de 97% da água do planeta.</span> O que representa um
              dos bens mais valiosos para a vida.
            </p>
            <p>
              A Seafety apresenta a solução que leva mais sustentabilidade para
              os oceanos com <span> informações e insights</span> sobre ele.
            </p>
          </div>
        </div>
        <div className="icons-text">
          ...
          <div className="circle-container">
            ...
            <div className="text-icon">
              <p>
                Nós conectamos o fundo do mar com o mundo, para um futuro que
                ambos beneficiam-se.
              </p>
              <p>
                A Seafety utiliza inteligência artificial para analisar dados
                oceânicos em tempo real, promovendo práticas sustentáveis e
                ajudando a preservar nossos oceanos.
              </p>
            </div>
          </div>
          <div className="box-icons">
        ...
        <div className="box-video">
          ...
          <div className="text-overlay">
            <h1>
              {" "}
              Nossas análises ajudam a minimizar o impacto ambiental das
              atividades marítimas.
            </h1>
            <p>
              A Seafety prevê condições marítimas e identifica padrões,
              proporcionando previsões confiáveis que auxiliam na tomada de
              decisões estratégicas, garantindo operações mais seguras e
              eficientes em águas abertas.
            </p>
          </div>
        </div>
        <div className="box-text">
          ...
          <div className="text-container">
            <h4>
              Nos comprometemos em promover a conscientização ambiental e
              educação
            </h4>
            <p>
              Nossa plataforma de inteligência artificial é acessível ao
              público, permitindo que qualquer pessoa acompanhe a segurança
              marítima e a sustentabilidade dos oceanos, utilizando dados e
              previsões avançadas para se envolver ativamente na causa da
              conservação.
            </p>
            <Link to="/TubAI">
        ...
        <div className="box-text">
          <div className="text-container">
            <h4>
              Promovemos a segurança e a eficiência no transporte marítimo
            </h4>
            <p>
              Nossa plataforma de inteligência artificial oferece aos
              marinheiros acesso a dados precisos e previsões avançadas,
              permitindo a escolha das melhores rotas e garantindo operações
        ...
        <div className="kindafooter">
          ...
          <div className="text1footer">
            ...
            <p>
              Tudo que oferecemos e lançamos é parte de um esforço contínuo para
              preservar a saúde dos nossos oceanos.{" "}
            </p>
